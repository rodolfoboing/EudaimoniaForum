    ...
    private void enviarEmailRecuperacao() {
        ...
        authManager.recuperarSenha(email, new AuthManager.PasswordResetCallback() {
            ...
            public void onSuccess() {
                ...
                Toast.makeText(RecuperarSenhaActivity.this, "E-mail de recuperação enviado! Verifique sua caixa de entrada.", Toast.LENGTH_LONG).show();
                finish();
            }
            ...
            public void onError(String errorMessage) {
                if (isFinishing() || isDestroyed()) return;
                Toast.makeText(RecuperarSenhaActivity.this, "Falha ao enviar e-mail: " + errorMessage, Toast.LENGTH_LONG).show();
            }
        });
    }
}