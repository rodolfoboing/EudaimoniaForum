...
public class RegistrarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.util.Log.d(TAG, "onCreate() chamado. Inicializando RegistrarActivity.");
    ...
    private void processarRegistro() {
        ...
        if (!checkBoxTermos.isChecked()) {
            Toast.makeText(RegistrarActivity.this, "Você precisa aceitar os Termos de Uso.", Toast.LENGTH_SHORT).show();
            return;
        }

        if (!checkBoxMaiorIdade.isChecked()) {
            Toast.makeText(RegistrarActivity.this, "Você precisa confirmar que tem 18 anos ou mais.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        authManager.verificarNickERegistrar(email, password, nickDesejado, vicioSelecionado, new AuthManager.RegisterCallback() {
            ...
            public void onSuccess() {
                dispensarDialogo();
                Toast.makeText(RegistrarActivity.this, "Usuário registrado com sucesso!", Toast.LENGTH_SHORT).show();
                irParaSetupPerfil();
            }
            ...
            public void onError(String errorMessage) {
                dispensarDialogo();
                Toast.makeText(RegistrarActivity.this, errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
