...
public class SetupProfileActivity extends AppCompatActivity {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (user != null) {
                        nickOriginal = user.getNick();
                        textViewNickAtual.setText("Nick atual: " + nickOriginal);

                        if (user.getAvatar() != null) {
                            avatarEscolhido = user.getAvatar();
                            AvatarUtils.carregarAvatar(SetupProfileActivity.this, imageViewAvatarPreview, avatarEscolhido);
                            destacarAvatarEscolhido(avatarEscolhido);
                        }

                        if (user.getSobreMim() != null && !user.getSobreMim().equals("Bem-vindo ao meu profile!")) {
                            editTextSobreMim.setText(user.getSobreMim());
                        }
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SetupProfileActivity.this, "Erro ao carregar dados.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void configurarAvatares() {
        for (int i = 1; i <= AvatarUtils.TOTAL_AVATARES; i++) {
            ...
            imgView.setOnClickListener(v -> {
                ...
                AvatarUtils.carregarAvatar(SetupProfileActivity.this, imageViewAvatarPreview, nomeIcone);
    ...
    private void aplicarMudancas(FirebaseUser user, String nickFinal, String sobreMim, boolean mudouNick) {
        ...
        // Marcar profile como configurado
            ...
            FirebaseDatabase.getInstance().getReference().updateChildren(updates)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(this, "Erro ao salvar profile.", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
    ...
    private void navegarParaOnboarding() {
        ...
        // significa que é uma conta nova (ou que nunca configurou o profile), então DEVE ver o onboarding.
    ...
    public void onBackPressed() {
        ...
        Toast.makeText(this, "Configure seu profile ou clique em 'Pular'.", Toast.LENGTH_SHORT).show();
    }
}
